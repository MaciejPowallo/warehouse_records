...
class Return_transportsMediator extends Controller
{
// Wyświetla wszystkie pozycje
    ...
    // Wynik zapytanie bez wyszukiwania szczegółów
        ...
        // Zwrócenie wyniku
            return view('transports.mediate.index')->with('transports', $transports)->with('counter', $counter); 
    }
    ...
    public function show($id)
    {
        ...
        if($approved != 1){
        	...
        	if($accepted === NULL) {
        		...
        		return view('transports.mediate.show')->with('transport', $transport);
	        }
    	}
    }
...
// Edycja elementu
    public function edit($id)
    {
        ...
        return view('transports.mediate.edit')->with('transport', $transport);
    }
