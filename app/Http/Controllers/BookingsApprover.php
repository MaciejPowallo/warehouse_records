...
class BookingsApprover extends Controller
{
// Wyświetla wszystkie pozycje
    ...
    // Wynik zapytanie bez wyszukiwania szczegółów
        ...
        // Zwrócenie wyniku
            return view('bookings.approved.index')->with('bookings', $bookings)->with('counter', $counter); 
    }
...
//Wyświetla pojedynczą pozycję
    public function show($id)
    {
        ...
        if($approved != 1){
        	...
        	if($accepted === NULL) {
        		return view('bookings.approved.show')->with('booking', $booking);
        	}
	        else{
...
// Edycja elementu
    public function edit($id)
    {
        ...
        return view('bookings.approved.edit')->with('booking', $booking);
    }
