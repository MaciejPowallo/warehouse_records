...
<div class="content-position">
	<div class="col-md-10 col-md-offset-1">
		<div class="panel-body">
			...
			<!-- Formularz -->
			{!! Form::model($booking, [ 'method'=>'PATCH', 'class'=>'form-horizontal marg_b100', 'action'=>['BookingsApprover@update', $booking->id]]) !!}

				<!-- Pola formularza -->
			<div class="row">
				<div class="col-sm-11 text-center">
				 <strong><h3>Czy na pewno chcesz zatwiedzić rezerwację o numerze:	{{ $booking->doc_numb }}</h3></strong>
				</div>
			</div>
				...
				<div class="form-group form-show control-label">
					<div class="col-sm-12 text-center">
                   		...
                   		@include('panel.button.undo_approved_button',['controller'=>'BookingsController@show', 'route'=>$booking->id])
					</div>
				</div>
			{!! Form::close() !!}
		</div>
