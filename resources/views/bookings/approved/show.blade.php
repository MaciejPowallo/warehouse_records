		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-sm-11 text-center">
				 <strong><h3>Rezerwacja numer:	{{ $booking->doc_numb }} <i class="red_text">(oczekuje na odpowiedź)</i></h3></strong>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-sm-5 col-sm-offset-1 text-right">	
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.list_button',['controller'=>'BookingsApprover@index'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.mediate_button',['controller'=>'BookingsMediator@edit', 'route'=>$booking->id])
					</div>
					<div class="col-xs-12 marg_b10" >
