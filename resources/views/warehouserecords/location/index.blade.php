...
<div class="content-position">
	<div class="panel panel-group panel-default">
    	<div class="panel-heading">
    		<p class="size-2">Stany lokalizacji
    			<h5> 
    	...
    	<div class="panel-body">
			<div class="row">
				...
				<!-- Przycisk wyczyszczenia filtrów -->
                   	@include('panel.button.clearsearch_button', ['controller'=>'LocationQuantity@index'])
				</div>
				<div class="col-sm-8">

					@include('panel.searchlocation',['table'=>'warehouserecords/location', 'name'=>'location', 'type1'=>Request::get('locations'), 'type2'=>Request::get('search_catalog_nr'), 'type3'=>Request::get('search_product_name') ])
				</div>
			</div>  	
