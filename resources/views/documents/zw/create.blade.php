@extends('master')
	@section('title')
		Dodawanie dokumentu wydania ZW
	@endsection
		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-xs-12 text-center">
				 <strong><h3>Nowy zwrot na magazyn (ZW)</i></h3></strong>
				</div>
			</div>
				<!-- Formularz -->
			{!! Form::open(['url'=>'documents/zw', 'class'=>'form-horizontal marg_b100']) !!}
			...
			<div></div>
				...
				<div class="form-group form-show control-label">
					<div class="col-sm-12 text-center">
                   		...
                   		@include('panel.button.list_button',['controller'=>'Zw_documentsController@index'])
					</div>
				</div>
			{!! Form::close() !!}
		</div>
