	...
	<div class="col-md-10 col-md-offset-1">
		<div class="panel-body">
			...
			<div class="row">
				...
				{{ $zw_document->created_at->format('d-m-Y') }}
				</div>
			</div>

			<div class="row">
				<div class="col-sm-11 text-center">
					<strong><h3>(ZW) Zwot na magazyn:	{{ $zw_document->doc_numb }} <i class="red_text">(Niezatwierdzony)</i></h3></strong>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-sm-5 col-sm-offset-1 text-right">	
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.add_product_button',['controller'=>'Zw_documentsController@edit', 'route'=>$zw_document->id, 'name' => 'Dodaj produkt'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.document_list_button',['controller'=>'Zw_documentsController@index'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.approved_button',['controller'=>'Zw_documentsApprover@edit', 'route'=>$zw_document->id])
					</div>
				</div>
			</div>
