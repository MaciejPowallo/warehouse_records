	...
	<div class="col-md-10 col-md-offset-1">
		<div class="panel-body">
			...
			<div class="row">
				...
				{{ $lt_document->updated_at->format('d-m-Y') }}
				</div>
			</div>

			<div class="row">
				<div class="col-sm-11 text-center">
					<strong><h3>(LT) Likwidacja:	{{ $lt_document->doc_numb }}</h3></strong>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-sm-5 col-sm-offset-1 text-right">	
					...
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.list_button',['controller'=>'Lt_documentsApprover@index'])
					</div>
				</div>
			</div>
