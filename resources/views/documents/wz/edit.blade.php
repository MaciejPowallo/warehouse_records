...
<div class="content-position">
	<div class="col-md-10 col-md-offset-1">
		<div class="panel-body">
    		@if(Session::has('mes_quantity_too_much'))
				<div class="alert alert-success text-left"><i class="fa fa-check-square-o fa-2x" aria-hidden="true"></i>{{ Session::get('mes_quantity_too_much') }}</div>
    		@endif
			<!-- Formularz -->
			{!! Form::model($wz_document, [ 'method'=>'PATCH', 'class'=>'form-horizontal marg_b100', 'action'=>['Wz_documentsController@update', $wz_document->id]]) !!}
