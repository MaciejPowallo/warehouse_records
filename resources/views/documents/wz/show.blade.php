	...
	<div class="col-md-10 col-md-offset-1">
		<div class="panel-body">
			...
			<div class="row">
				...
				{{ $wz_document->created_at->format('d-m-Y') }}
				</div>
			</div>
			...
			<div class="row">
				...
				@if($wz_document->expend == 0)
					<strong><h3>(WZ) Wydanie magazynowe:	{{ $wz_document->doc_numb }} <i class="red_text">(Niezatwierdzony)</i></h3></strong>
				@endif
				@if($wz_document->expend == 1)
					<strong><h3>(RW) Rozchód wewnętrzny:	{{ $wz_document->doc_numb }} <i class="red_text">(Niezatwierdzony)</i></h3></strong>
				@endif
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-sm-5 col-sm-offset-1 text-right">	
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.add_product_button',['controller'=>'Wz_documentsController@edit', 'route'=>$wz_document->id, 'name' => 'Dodaj produkt'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.document_list_button',['controller'=>'Wz_documentsController@index'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.approved_button',['controller'=>'Wz_documentsApprover@edit', 'route'=>$wz_document->id])
					</div>
				</div>
			</div>
