		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-sm-11 text-center">
				 <strong><h3>Transport numer:	{{ $transport->doc_numb }} <i class="red_text">(oczekuje na odpowiedź)</i></h3></strong>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-sm-5 col-sm-offset-1 text-right">	
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.list_button',['controller'=>'Return_transportsApprover@index'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.mediate_button',['controller'=>'Return_transportsMediator@edit', 'route'=>$transport->id])
					</div>
					<div class="col-xs-12 marg_b10" >
			...
			<div class="row marg_t50 marg_b100">
				...
				<div class="table-bordered col-sm-offset-1 col-sm-4 col-xs-4 text-center signature always_hidden">
					<div><div>{{ $transport->approved_by }}  {{$transport->created_at->format('d-m-Y')}} </div></div>
