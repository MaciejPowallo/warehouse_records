		...
		<div class="panel-body">
			...
			<div class="row">
				<div class="col-sm-11 text-center">
				 <strong><h3>Transport numer:	{{ $transport->doc_numb }} <i class="red_text">(Niezatwierdzony)</i></h3></strong>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-sm-5 col-sm-offset-1 text-right">	
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.add_product_button',['controller'=>'Return_transportsController@edit', 'route'=>$transport->id, 'name' => 'Dodaj produkt'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.document_list_button',['controller'=>'Return_transportsController@index'])
					</div>
					<div class="col-xs-12 marg_b10" >
	                   	@include('panel.button.approved_button',['controller'=>'Return_transportsApprover@edit', 'route'=>$transport->id])
					</div>
				</div>
			</div>
			...
			<div class="row marg_t50 marg_b100">
				...
				<div class="table-bordered col-sm-offset-1 col-sm-3 col-xs-4 text-center signature always_hidden">
					<div><div> <br/></div></div>
