	...
	<div class="col-md-10 col-md-offset-1">
		<div class="panel-body">
				...
				<div class="form-group form-bottom-marg control-label">
					<div class="col-sm-12">
						<!-- Widomość z sesji -->
			    		@if(Session::has('mes_location_update'))
			   				<div class="alert alert-success text-left"><i class="fa fa-check-square-o fa-2x" aria-hidden="true"></i>{{ Session::get('mes_location_update') }}</div>
			    		@endif
					</div>
				</div>
